...
ipa-server-install  --unattended --setup-dns --forwarder 8.8.8.8 --auto-reverse --ip-address `hostname -I` --hostname=`hostname -s`.$DOMAIN -a $PASSWORD -n $DOMAIN -p $PASSWORD  -r $REALM --idstart=8000 --idmax=10000
